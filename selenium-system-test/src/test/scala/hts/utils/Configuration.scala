...
object Configuration {
  ...
  val (host: String, authHost: String, ggHost: String, feedbackHost: String, ggRegistrationHost: String) = {
    environment match {
      case Environment.Local | Environment.Dev ⇒ ("http://localhost:7000", "http://localhost:9949", "http://localhost:9025", "http://localhost:9250", "http://localhost:8571")
