...
import uk.gov.hmrc.helptosavefrontend.models.email.VerifyEmailError.{AlreadyVerified, BackendError, RequestNotValidError, VerificationServiceUnavailable}
...
class AccountHolderUpdateEmailAddressControllerSpec extends AuthSupport {
  ...
  lazy val controller = new AccountHolderUpdateEmailAddressController(
    ...
    mockMetrics,
    mockAuditor
  )(fakeApplication, crypto, mockEmailValidation, fakeApplication.injector.instanceOf[MessagesApi], ec) {
